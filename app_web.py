...
def load_my_model():
    ...
    file_id = '1pN19MtJwZO9BRUk8wSBnKaKCfbGH4I5w' 
    url = f'https://drive.google.com/uc?id={file_id}'
    
    if not os.path.exists(model_path):
        # Spinner ini hanya muncul sekali saat download pertama kali
        with st.spinner('Menyiapkan otak AI... Mohon tunggu sebentar.'):
